...
var _listeners = __webpack_require__(20);
...
var _subscriptions = __webpack_require__(24);

var _subscriptions2 = _interopRequireDefault(_subscriptions);

var _methods = __webpack_require__(25);
...
var LineString = /*#__PURE__*/function (_Geometry) {
  ...
  function LineString(points, srs) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(LineString).call(this, srs));
    _this.points = points || [];
    return _this;
  }
...
var Point = /*#__PURE__*/function (_Geometry) {
  ...
  function Point(srs) {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(Point).call(this, srs));
  }
...
var Polygon = /*#__PURE__*/function (_Geometry) {
  ...
  function Polygon(boundary, holes, srs) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(Polygon).call(this, srs));
...
var _parse = __webpack_require__(/*! ../store/parse */ "./src/data/store/parse.js");
...
function findById() {
  ...
  if (_utils["default"].isString(arguments[0])) {
    ...
    if (_utils["default"].getClassName(arguments[0]) === 'Object') {
...
var _utils2 = __webpack_require__(/*! ../utils */ "./src/data/utils.js");
...
var DataStore = /*#__PURE__*/function () {
  function DataStore(model, classToTableMap, app) {
    ...
    if (_utils["default"].isString(model)) {
      this.className = model;
      this.model = classToTableMap[this.className] || (0, _utils2.resolveModelClassFromString)(this.className);
    } else {
...
var geoClasses = ['com.backendless.persistence.Polygon', 'com.backendless.persistence.LineString', 'com.backendless.persistence.Point', 'com.backendless.persistence.Geometry'];
...
function parseFindResponse(response, Model, classToTableMap) {
  var sanitizeResponseItem = function sanitizeResponseItem(record) {
    Model = _utils["default"].isFunction(Model) ? Model : (0, _utils2.resolveModelClassFromString)(record.___class);
    return _utils["default"].deepExtend(new Model(), record, classToTableMap);
  };

  var result = _utils["default"].isArray(response) ? response.map(sanitizeResponseItem) : sanitizeResponseItem(response);
...
function save(obj, asyncHandler) {
  ...
  return _utils["default"].deepExtend(objRef, (0, _parse.parseFindResponse)(result, this.model), this.classToTableMap);
}
...
function resolveModelClassFromString(className) {
  if (className === _user["default"].className) {
  ...
  return function (target, prop, descriptor) {
    ...
    descriptor.initializer = function () {
      return function () {
        ...
        var helpMessage = "Please use \"".concat(alternative, "\" instead of."); // eslint-disable-next-line no-console
...
var Geo = (_dec = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.savePoint'), _dec2 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.find'), _dec3 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.loadMetadata'), _dec4 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.getClusterPoints'), _dec5 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.relativeFind'), _dec6 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.addCategory'), _dec7 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.getCategories'), _dec8 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.deleteCategory'), _dec9 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.deletePoint'), _dec10 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.getFencePoints'), _dec11 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.getGeopointCount'), _dec12 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.runOnEnterAction'), _dec13 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.runOnStayAction'), _dec14 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.runOnExitAction'), _dec15 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.startGeofenceMonitoringWithInAppCallback'), _dec16 = (0, _decorators.deprecated)('Backendless.Geo', 'Backendless.Geo.startGeofenceMonitoringWithRemoteCallback'), (_class = /*#__PURE__*/function () {
  ...
  return Geo;
}(), ((0, _applyDecoratedDescriptor2["default"])(_class.prototype, "savePointSync", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "savePointSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "findSync", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "findSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "loadMetadataSync", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "loadMetadataSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "getClusterPointsSync", [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, "getClusterPointsSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "relativeFindSync", [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, "relativeFindSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "addCategorySync", [_dec6], Object.getOwnPropertyDescriptor(_class.prototype, "addCategorySync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "getCategoriesSync", [_dec7], Object.getOwnPropertyDescriptor(_class.prototype, "getCategoriesSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "deleteCategorySync", [_dec8], Object.getOwnPropertyDescriptor(_class.prototype, "deleteCategorySync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "deletePointSync", [_dec9], Object.getOwnPropertyDescriptor(_class.prototype, "deletePointSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "getFencePointsSync", [_dec10], Object.getOwnPropertyDescriptor(_class.prototype, "getFencePointsSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "getGeopointCountSync", [_dec11], Object.getOwnPropertyDescriptor(_class.prototype, "getGeopointCountSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "runOnEnterActionSync", [_dec12], Object.getOwnPropertyDescriptor(_class.prototype, "runOnEnterActionSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "runOnStayActionSync", [_dec13], Object.getOwnPropertyDescriptor(_class.prototype, "runOnStayActionSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "runOnExitActionSync", [_dec14], Object.getOwnPropertyDescriptor(_class.prototype, "runOnExitActionSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "startGeofenceMonitoringWithInAppCallbackSync", [_dec15], Object.getOwnPropertyDescriptor(_class.prototype, "startGeofenceMonitoringWithInAppCallbackSync"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "startGeofenceMonitoringWithRemoteCallbackSync", [_dec16], Object.getOwnPropertyDescriptor(_class.prototype, "startGeofenceMonitoringWithRemoteCallbackSync"), _class.prototype)), _class));
exports["default"] = Geo;
...
function responseParser(resp, geoQuery) {
  return resp.map(function (geoObject) {
    ...
    return new GeoItem(_objectSpread({}, geoObject, {
      geoQuery: geoQuery
    }));
  });
}
...
var parseInitConfig = function parseInitConfig() {
  ...
  if (_utils["default"].isObject(appId)) {
    return appId;
  }
...
var Backendless = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Backendless, [{
    ...
    value: function setupDevice() {
      var _require = __webpack_require__(/*! ./device */ "./src/device/index.js"),
      ...
      this.__device = (0, _construct2["default"])(Device, args);
    } ///----------UTIL METHODS--------///
...
var LocalStorageCache = /*#__PURE__*/function (_Cache) {
  ...
  function LocalStorageCache() {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(LocalStorageCache)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function cancel(messageId, asyncHandler) {
  return this.app.request["delete"]({
    ...
    isAsync: !!asyncHandler,
    asyncHandler: new _async["default"]()
  });
}
...
var Request = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Request, [{
    ...
    value: function get(config) {
      return this.send(_objectSpread({}, config, {
        method: Methods.GET
      }));
    }
  }, {
...
var RemoteSharedObject = (_dec = _rt.RTScopeConnector.connectionRequired(), _dec2 = _rt.RTScopeConnector.connectionRequired(), _dec3 = _rt.RTScopeConnector.connectionRequired(), _dec4 = _rt.RTScopeConnector.connectionRequired(), _dec5 = _rt.RTScopeConnector.connectionRequired(true), _dec6 = _rt.RTScopeConnector.connectionRequired(true), _dec7 = _rt.RTScopeConnector.connectionRequired(true), _dec8 = _rt.RTScopeConnector.connectionRequired(true), _dec9 = _rt.RTScopeConnector.connectionRequired(true), (_class = (_temp = /*#__PURE__*/function (_RTScopeConnector) {
  ...
  function RemoteSharedObject(options, app) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(RemoteSharedObject).call(this, options));
  ...
  (0, _createClass2["default"])(RemoteSharedObject, [{
    ...
    key: "get",
    value: function get(key) {
      return this.app.RT.methods.getRSO(_objectSpread({}, this.getScopeOptions(), {
        key: key
      }));
    }
  }, {
    ...
    value: function set(key, data) {
      return this.app.RT.methods.setRSO(_objectSpread({}, this.getScopeOptions(), {
        key: key,
        data: data
      }));
    }
    ...
    value: function invokeOn(method, targets) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this2.app.RT.methods.invokeRSOMethod(_objectSpread({}, _this2.getScopeOptions(), {
          method: method,
          targets: targets,
          args: args
        }));
...
var RemoteSharedObjects = /*#__PURE__*/function () {
  function RemoteSharedObjects(options, app) {
...
var RT = /*#__PURE__*/function (_BackendlessRTClient) {
  ...
  function RT(app) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(RT).call(this, {
      appId: appId,
